...
exports.verifyNewUserOtp = async (req, res) => {
    ...
    try {
        ...
        // --- FIX: Pass the phone number separately to User.create ---
        const newUser = await User.create({
            phone: otpEntry.phone, // Pass the phone number here
            ...otpEntry.userData, // Use the temporary data to create the user
            isPhoneVerified: true // Set to true since it's now verified
        });
