...
exports.submitBasicInfo = async (req, res) => {
    ...
    try {
        const result = await model.processAndStoreBasicInfo(data);
...
exports.submitHealthHistory = async (req, res) => {
    const data = req.body;
    const userId = data.userId; // Assuming userId is passed in the body
...
exports.submitBiomarkers = async (req, res) => {
    const data = req.body;
    const { userId, ...o7Data } = data; // Destructure userId and capture the rest of the body as o7Data
